...
var Lightbox = (function ($) {
	...
	var Default = {
		...
		leftArrow: '<span><i class="ion-ios-arrow-left"></i></span>',
		rightArrow: '<span><i class="ion-ios-arrow-right"></i></span>',
		strings: {
			close: 'Close',
    ...
    _padding / _border: CSS properties for the modal container; these are used to calculate the available space for the content
   	 */
		...
		function Lightbox($element, config) {
			...
			var body = '<div class="modal-body"><a class="close" data-dismiss="modal"><i class="ion-ios-close-empty"></i></a><div class="ekko-lightbox-container"><div class="ekko-lightbox-item fade in show"></div><div class="ekko-lightbox-item fade"></div></div></div>';
			...
			if (this._galleryName) {
				...
				if (this._config.showArrows && this._$galleryItems.length > 1) {
					this._$lightboxContainer.append('<div class="ekko-lightbox-nav-overlay"><a id="left" href="#">' + this._config.leftArrow + '</a><a id="right" href="#">' + this._config.rightArrow + '</a></div>');
